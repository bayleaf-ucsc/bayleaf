...
| [602.3](https://www.access-board.gov/ict/#602.3) | Electronic Support Documentation | Supports | Support is documented via [SUPPORT.md](https://github.com/bayleaf-ucsc/bayleaf/blob/main/SUPPORT.md) (GitHub-served markdown, outside the [VPAT-pages.md](VPAT-pages.md) scope) and the [SKILL.md at /docs/SKILL.md](https://api.bayleaf.dev/docs/SKILL.md) (BayLeaf-authored Markdown served as `text/markdown`). |
